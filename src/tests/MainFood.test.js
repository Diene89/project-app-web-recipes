...
describe.only('Testa componentes da tela de comidas principal', () => {
  ...
  it('Verifica se todos os cards estao presentes e com as infos corretas', async () => {
    await act(async () => {
      const { history } = renderWithRouter(<App />);
      history.push('/foods');
    });
  ...
  it('Verifica se todos os botoes de filtros estao presentes', async () => {
    await act(async () => {
      const { history } = renderWithRouter(<App />);
      history.push('/foods');
    });
  ...
  it('Verifica se ao clicar no botao de filtro o conteudo da pagina muda', async () => {
    const { history } = renderWithRouter(<App />);
    history.push('/foods');
